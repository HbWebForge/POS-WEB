...
const AuthDB = {
  ...
  products: [
    ...
    {  id: 7,name: "Shami  burger",category: 1,  price: 150, icon: "🍔",  },
    {  id: 7,name: "double egg burger",category: 1,  price: 220, icon: "🍔",  },
    {  id: 7,name: "double Chicken burger",category: 1,  price: 300, icon: "🍔",  },
    { id: 8, name: "Chicken shawarma", category: 2, price: 220, icon: "🌯" },
    { id: 9, name: "Zinger shawarma", category: 2, price: 300, icon: "🌯" },
    { id: 9, name: "Small shawarma", category: 2, price: 170, icon: "🌯" },
    { id: 9, name: "Large shawarma", category: 2, price: 220, icon: "🌯" },
    ...
    { id: 22, name: " Full Loaded fries", category: 6, price: 600, icon: "🍟" },
    { id: 22, name: "Half  Loaded fries", category: 6, price: 350, icon: "🍟" },
    { id: 23, name: "Masala fries", category: 6, price: 320, icon: "🍟" },
    { id: 24, name: " Full Regular fries", category: 6, price: 300, icon: "🍟" },
    { id: 24, name: "Half Regular fries", category: 6, price: 150, icon: "🍟" },
    ...
    { id: 27, name: "Sting ", category: 7, price: 80, icon: "🥤" },
    { id: 28, name: "500 ml Sting ", category: 7, price: 150, icon: "🥤" },
    { id: 29, name: "Regular drink ", category: 7, price: 60, icon: "🥤" },
    { id: 30, name: "500 ml drink ", category: 7, price: 120, icon: "🥤" },
    { id: 31, name: "Nr 345 ml drink ", category: 7, price: 90, icon: "🥤" },
    { id: 32, name: "1.5 Ltr water", category: 7, price: 120, icon: "🥤" },
    { id: 33, name: "1 Ltr Drink", category: 7, price: 170, icon: "🥤" },
    { id: 34, name: "1.5 Ltr Drink", category: 7, price: 220, icon: "🥤" },
