...
const AuthDB = {
    ...
    categories: [
        ...
        { id: 6, name: 'Chicken PCS', icon: '🍗' },
        { id: 7, name: 'Nuggets', icon: '🧽' },
        { id: 8, name: 'Hot wings', icon: '🪽' },
        { id: 9, name: 'Chicken Biryani ', icon: '🥘' },
    ...
    products: [
        ...
        { id: 3, name: 'RFC special burger', category: 1, price: 500, icon: '🍔' },
        { id: 3, name: 'Double decker burger', category: 1, price: 550, icon: '🍔' },
        { id: 3, name: 'Chicken patty burger', category: 1, price: 250, icon: '🍔' },
        { id: 3, name: 'Chicken grill burger', category: 1, price: 550, icon: '🍔' },
